...
//
//@optional
//- (void)adapter:(Yodo1MasAdapterBase *)adapter didBannerAdLoad:(UIView *)banner;
//- (void)adapter:(Yodo1MasAdapterBase *)adapter didBannerAdLoadFail:(Yodo1MasError *)error;
//- (void)adapter:(Yodo1MasAdapterBase *)adapter didBannerAdOpen:(UIView *)banner;
//- (void)adapter:(Yodo1MasAdapterBase *)adapter didBannerAdClose:(UIView *)banner;
//- (void)adapter:(Yodo1MasAdapterBase *)adapter didBannerAdOpenFail:(Yodo1MasError *)error;
//
//@end
